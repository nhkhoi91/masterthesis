...
A survey of the techniques used in content-based recommender will be discussed later. For the moment, some music features as well as the techniques that are used to extract them will be described. Next, an overview of three typical similarity measurements that are often applied in content-based music recommender system \cite{magno2008comparison} will be mentioned. 

\todo{rephrase, add profile learner part}
...
\multirow{5}{|c|}{Timbre} & Zero Crossing Rate & \cite{tzanetakis2002musical}, \cite{li2003comparative}, \cite{bergstra2006aggregate} \\
...
\multirow{3}{|c|}{Temporal} & Statistical Moments & \cite{tzanetakis2002musical}, \cite{li2003comparative} \\
...
\begin{itemize}
\item[•] K-means clustering with Earth-Mover’s Distance: 
\end{itemize}
